...
function scoresAverage(moviesArray) {
    ...
    let totalScore = moviesArray.reduce((accumulator, movie) => accumulator + movie.score, 0);
...
function dramaMoviesScore(moviesArray) {
    ...
    let dramaMoviesAvg = dramaMovies.reduce((accumulator, movie) => accumulator + movie.score, 0) / dramaMovies.length;
    return dramaMoviesAvg = parseFloat(dramaMoviesAvg.toFixed(2))
}
